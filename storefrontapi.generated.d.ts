...
> & {
  ...
  variants: {edges: Array<{node: Pick<StorefrontAPI.ProductVariant, 'id'>}>};
};
  ...
  products: {
    nodes: Array<
      Pick<StorefrontAPI.Product, 'id' | 'title' | 'handle'> & {
        ...
        variants: {
          edges: Array<{node: Pick<StorefrontAPI.ProductVariant, 'id'>}>;
        };
      }
    >;
  };
...
export type HomePageQuery = {
  page?: StorefrontAPI.Maybe<
    Pick<StorefrontAPI.Page, 'title' | 'id'> & {
...
> & {
  images: {
    edges: Array<{node: Pick<StorefrontAPI.Image, 'id' | 'url' | 'altText'>}>;
  };
